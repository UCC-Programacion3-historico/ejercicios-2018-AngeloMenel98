...
template<class K, class T>
T ArbolBinarioAVL<K, T>::getdato() {
    return getdato(raiz);
}

template<class K, class T>
T ArbolBinarioAVL<K, T>::getdato(NodoArbolAVL<K, T> *r) {
    if (r == nullptr)
        throw 404;
    return r->dato;
}
...
template<class K, class T>
int ArbolBinarioAVL<K, T>::tamanio() {
    int tam = tamanio(raiz);
    return tam;
}

template<class K, class T>
int ArbolBinarioAVL<K, T>::tamanio(NodoArbolAVL<K, T> *r) {
    if (r == nullptr)
        return 0;
    return 1 + tamanio(r->izq) + tamanio(r->der);
}

template<class K, class T>
void ArbolBinarioAVL<K, T>::inorder() {
    inorder(raiz);
}

template<class K, class T>
void ArbolBinarioAVL<K, T>::inorder(NodoArbolAVL<K, T> *r) {
    if (r == nullptr)
        return;
